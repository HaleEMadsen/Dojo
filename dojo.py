        ...
        if not user_attempt:
            ...
            with st.spinner("Evaluating..."):
                try:
                    ...
                    3. CONSTRAINT:
                    Responses may include up to 2 sentences. The first sentence must succinctly explain how the cadet should have found the correct answer and why their answer is wrong. Especially on images, give a tip for how to identify the correct answer instead of theirs. e.g. The Cadet Major rank has a thin stripe while all of the cadet lieutenant colonel's stripes are thick. The second sentence is a short, punchy, and aggressive one-liner or roast.
                    """
